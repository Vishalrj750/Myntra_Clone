import { ADD_TO_BAG, ADD_TO_WISHLIST, DELETE_FROM_BAG, DELETE_FROM_WISHLIST, TOGGLE_AUTH, ADD_TO_TSHIRT, ADD_TOTAL, SUBTRACT_TOTAL, FILTER_TSHIRT_ROADSTER } from "./actionType";
...
export const filterTshirtRoadster = ( payload ) => {
    return {
        type: FILTER_TSHIRT_ROADSTER,
        payload
    }
}
